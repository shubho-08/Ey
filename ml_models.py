...
os.environ["_BARD_API_KEY"] = "dQj8xpQpnQGqPrjaTYdgAvaiK823UXxAXvOqjZQ7EZrjLoGzyMm3NBHhZcAoYjacKWfPqg."
...
def get_answer(prompt):
    ...
    elif any(place_keyword in prompt.lower() for place_keyword in ['generate dress', 'make', 'suggest']):
        result = {
    ...
    elif any(place_keyword in prompt.lower() for place_keyword in ['location', 'place', 'city', 'special occasion', 'occasion']):
        result = {
